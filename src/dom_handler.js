...
export const displayFooter = (data) => {
  ...
  timeSection1.querySelector(".time").textContent = timeSection1Date.slice(
    11,
    16,
  );
  timeSection1.querySelector(".temp").textContent =
    `${timeSection1Path.temp_c}°c`;
  ...
  timeSection2.querySelector(".time").textContent = timeSection2Date.slice(
    11,
    16,
  );
  timeSection2.querySelector(".temp").textContent =
    `${timeSection2Path.temp_c}°c`;
  ...
  timeSection3.querySelector(".time").textContent = timeSection3Date.slice(
    11,
    16,
  );
  timeSection3.querySelector(".temp").textContent =
    `${timeSection3Path.temp_c}°c`;
  ...
  timeSection4.querySelector(".time").textContent = timeSection4Date.slice(
    11,
    16,
  );
  timeSection4.querySelector(".temp").textContent =
    `${timeSection4Path.temp_c}°c`;
};
